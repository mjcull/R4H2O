...
ggplot(gormsey, aes(Measure)) + 
    geom_bar()
ggsave("manuscript/resources/session4/gormsey_measures.png", width = 6, height = 4)

## Add colour
ggplot(gormsey, aes(Measure)) + 
    geom_bar(fill = "chocolate4")
ggsave("manuscript/resources/session4/gormsey_measures_col.png", width = 6, height = 4)

# Aesthethics
ggplot(gormsey, aes(Measure, fill = Zone)) + 
    geom_bar()
ggsave("manuscript/resources/session4/gormsey_measures_zones.png", width = 6, height = 4)

# Coords flipped
ggplot(gormsey, aes(Zone, fill = Measure)) + 
    geom_bar() + 
    coord_flip()
ggsave("manuscript/resources/session4/gormsey_zones.png", width = 6, height = 6)
...
ggplot(samples, aes(Sample_Point, Samples)) +
    geom_col() 
ggsave("manuscript/resources/session4/gormsey_turbidity_merton.png", width = 6, height = 6)
...
ggsave("manuscript/resources/session4/gormsey_thm_time_series.png", width = 6, height = 6)
...
ggsave("manuscript/resources/session4/gormsey_thm_trend.png", width = 6, height = 6)
...
ggsave("manuscript/resources/session4/gormsey_thm_zone.png", width = 6, height = 6)
