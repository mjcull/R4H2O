## Parabola
png("manuscript/resources/answers/parabola.png")
x <- seq(-5, 3, .1)
y <- -x^2 - 2 * x + 3
plot(x, y, type = "l")
...
png("manuscript/resources/answers/histogram.png")
...
png("manuscript/resources/answers/boxplot-example.png")
par(mar = rep(0, 4))
...
## Turbidity results
turbidity <- read.csv("session2/turbidity_laanecoorie.csv")
png("manuscript/resources/answers/boxplot-zones.png")
